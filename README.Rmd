...
`homiMx` es un paquete en R para el análisis de **homicidios registrados en México** a partir de los microdatos de defunciones del INEGI (1990–2023).  
...
Este paquete se encuentra en desarrollo activo. La versión 1.1 incluye solo funciones tabulares. Las funciones de visualización estarán disponibles en la versión 2.0.
